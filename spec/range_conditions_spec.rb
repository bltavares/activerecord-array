...
describe ActiveRecord::Array::Base, "#Range" do
  #Example
  ##
  ##Client.where(:orders_count => 1..5)
  ##SELECT * FROM clients WHERE (clients.orders_count between 1 and 5)
  ...
  it "must accept array condition as an contains" do
    result = ar.where(:orders_count => 1..5)
